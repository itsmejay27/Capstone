import { buildTopicDrivenQuestionsForSpecs } from './src/app/services/geminiService';
import { TOSItemSpec } from './src/app/services/tosParser';

const mockSpecs: TOSItemSpec[] = [];
