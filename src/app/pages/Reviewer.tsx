...
export default function Reviewer() {
  ...
  const diffColor: Record<string, any> = {
    easy: { bg: 'var(--c-green-100)', color: 'var(--c-green-600)', border: 'var(--c-green-300)' },
    normal: { bg: '#fef9c3', color: '#ca8a04', border: '#fde047' },
    hard: { bg: 'var(--c-red-100)', color: 'var(--c-red-600)', border: 'var(--c-red-300)' },
  };
    ...
    return (
      <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        <Paper sx={{ mb: 4, borderRadius: 4, overflow: 'hidden', boxShadow: '0 8px 30px rgba(3,105,161,0.12)' }}>
          <Box sx={{ background: 'linear-gradient(135deg, var(--c-sky-700) 0%, var(--c-sky-500) 100%)', p: { xs: 3, md: 4 }, color: 'white' }}>
          ...
          <Box sx={{ p: { xs: 2, md: 3 }, bgcolor: 'var(--c-sky-50)', borderTop: '1px solid rgba(3,105,161,0.1)' }}>
            <TextField
              fullWidth placeholder="Search reviewers by title or subject..."
              value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)}
              size="small" sx={{ bgcolor: 'var(--c-surface)', borderRadius: 2 }}
            />
          </Box>
        </Paper>
        ...
        {filteredReviewers.length === 0 ? (
          <Paper sx={{ p: 5, textAlign: 'center', borderRadius: 4, boxShadow: '0 4px 20px rgba(0,0,0,0.05)' }}>
            <Box sx={{ width: 80, height: 80, borderRadius: '50%', bgcolor: 'rgba(3,105,161,0.08)', display: 'flex', alignItems: 'center', justifyContent: 'center', mx: 'auto', mb: 2 }}>
              <School sx={{ fontSize: 40, color: 'var(--c-sky-700)' }} />
            </Box>
              ...
              return (
                <Paper
                  ...
                  sx={{
                    ...
                    borderRadius: 3,
                    border: isCompleted ? '1px solid var(--c-green-300)' : '1px solid var(--c-slate-200)',
                    ...
                    '&:hover': {
                      ...
                      borderColor: isCompleted ? 'var(--c-green-300)' : 'var(--c-slate-300)',
                    },
                    display: 'flex',
                ...
                >
                  ...
                  <Box sx={{ display: 'flex', gap: 2.5, alignItems: 'flex-start', flexGrow: 1, minWidth: 0 }}>
                    <Box sx={{
                      ...
                      height: 46,
                      borderRadius: 2,
                      background: isCompleted ? 'linear-gradient(135deg, var(--c-green-600), #22c55e)' : 'linear-gradient(135deg, var(--c-sky-700) 0%, var(--c-sky-500) 100%)',
                      display: 'flex',
                      alignItems: 'center',
                    ...
                    <LinearProgress
                      ...
                      sx={{
                        ...
                        '& .MuiLinearProgress-bar': {
                          background: isCompleted ? 'linear-gradient(90deg, var(--c-green-600), #22c55e)' : 'linear-gradient(90deg, var(--c-sky-700), var(--c-sky-500))'
                        }
                      }}
                    />
                  </Box>
                    ...
                    <Box sx={{ display: 'flex', gap: 1, alignItems: 'center' }}>
                      <Button
                        ...
                        sx={{
                          ...
                          minWidth: 120,
                          ...(isCompleted
                            ? { color: 'var(--c-green-600)', borderColor: 'var(--c-green-600)' }
                            : { background: 'linear-gradient(135deg, var(--c-sky-700) 0%, var(--c-sky-500) 100%)' }
                          )
                        }}
                      >
                  ...
                  <CardContent sx={{
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', flexGrow: 1, minWidth: 0 }}>
                      <Box sx={{
                        ...
                        background: isPassed ? 'linear-gradient(135deg,var(--c-green-600),#22c55e)' : 'linear-gradient(135deg,var(--c-sky-700),var(--c-sky-500))',
                        color: 'white',
    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      <Grid container spacing={3.5}>
        ...
        <Grid size={{ xs: 12, md: 3.5 }}>
          <Paper sx={{ p: 2.5, borderRadius: 4, border: '1px solid var(--c-slate-200)', boxShadow: '0 4px 15px rgba(0,0,0,0.02)', position: 'sticky', top: 24 }}>
                ...
                return (
                  <Paper
                    ...
                    sx={{
                      ...
                      gap: 1.5,
                      '&:hover': {
                        borderColor: 'var(--c-sky-700)',
                        bgcolor: 'var(--c-slate-50)',
                      }
                    }}
                  >
                    <Box sx={{
                      ...
                      height: 28,
                      borderRadius: '50%',
                      bgcolor: isActive ? 'var(--c-sky-700)' : isPassed ? 'var(--c-emerald-500)' : 'var(--c-slate-500)',
                      color: 'white',
                      display: 'flex',
                      alignItems: 'center',
                      justifyContent: 'center',
                    ...
                    <Box sx={{ minWidth: 0, flexGrow: 1 }}>
                      <Typography variant="body2" fontWeight={isActive ? 800 : 600} sx={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', color: isActive ? 'var(--c-sky-700)' : 'text.primary' }}>
                        {m.topic}
                      </Typography>
                      <Typography variant="caption" color="text.secondary">
        ...
        <Grid size={{ xs: 12, md: 8.5 }}>
          ...
          {phase === 'lesson' && currentModule && (
            <Paper sx={{ borderRadius: 4, overflow: 'hidden', boxShadow: '0 4px 20px rgba(0,0,0,0.07)', border: '1px solid var(--c-slate-200)' }}>
              <Box sx={{ background: 'linear-gradient(135deg, var(--c-blue-900) 0%, var(--c-emerald-500) 100%)', p: 3, color: 'white' }}>
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
              ...
              <Box sx={{ p: { xs: 3, md: 4 } }}>
                {currentModule.lessonContent.split('\n').map((line: string, i: number) => {
                  ...
                  if (trimmed.startsWith('**') && trimmed.endsWith('**') && !trimmed.slice(2, -2).includes('**')) {
                    return <Typography key={i} variant="h6" fontWeight="bold" sx={{ mt: 2, mb: 1, color: 'var(--c-blue-900)' }}>{trimmed.slice(2, -2)}</Typography>;
                  }
          ...
          {phase === 'flashcards' && currentModule && (() => {
            ...
            return (
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3.5, animation: 'fadeIn 0.3s ease' }}>
                <Paper sx={{ p: 3, borderRadius: 4, bgcolor: '#fbfbfe', border: '1px solid var(--c-emerald-100)' }}>
                  ...
                  >
                    ...
                    {!isFlipped ? (
                      <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 2 }}>
                        <HelpOutline sx={{ fontSize: 44, color: 'var(--c-emerald-500)' }} />
                        ...
                        <Typography variant="h5" fontWeight="bold" sx={{ px: 2, lineHeight: 1.5, color: 'var(--c-slate-800)' }}>
                          {q.question}
                        </Typography>
                      ...
                      <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 2 }}>
                        <CheckCircle sx={{ fontSize: 44, color: 'var(--c-emerald-500)' }} />
                        <Typography variant="subtitle2" sx={{ fontWeight: 800, color: 'success.main', tracking: '0.1em' }}>
                          CORRECT ANSWER
                        </Typography>

                        <Typography variant="h5" fontWeight="black" sx={{ color: 'var(--c-emerald-800)', mb: 1 }}>
                          {q.type === 'multiple-choice' && q.options
          ...
          {phase === 'quiz' && currentModule && (
            <Box sx={{ animation: 'fadeIn 0.3s ease' }}>
              <Paper sx={{ p: 2.5, mb: 3, borderRadius: 3, background: 'linear-gradient(135deg, var(--c-blue-900), var(--c-emerald-500))', color: 'white' }}>
                ...
                <LinearProgress
                  ...
                  sx={{ mt: 1.5, height: 5, borderRadius: 3, bgcolor: 'rgba(255,255,255,0.2)', '& .MuiLinearProgress-bar': { bgcolor: 'var(--c-surface)' } }}
                />
              </Paper>
                  ...
                  <Paper key={q.id} sx={{ p: 3, borderRadius: 3, border: '1px solid rgba(0,0,0,0.08)', boxShadow: '0 2px 12px rgba(0,0,0,0.04)' }}>
                    <Box sx={{ display: 'flex', gap: 1.5, mb: 2 }}>
                      <Box sx={{
                        ...
                        background: answers[q.id] !== undefined ? 'linear-gradient(135deg,var(--c-blue-900),var(--c-emerald-500))' : 'var(--c-slate-100)',
                        color: answers[q.id] !== undefined ? 'white' : 'var(--c-slate-500)',
                      ...
                      <Box sx={{ flexGrow: 1 }}>
                        <Chip
                          ...
                          sx={{ mb: 1, bgcolor: q.type === 'identification' ? 'var(--c-amber-100)' : 'var(--c-emerald-50)', color: q.type === 'identification' ? 'var(--c-amber-800)' : 'var(--c-emerald-800)', fontWeight: 600, fontSize: '0.7rem' }}
                        />
                          ...
                          {['true', 'false'].map((val) => (
                            <FormControlLabel
                              ...
                              sx={{
                                ...
                                border: answers[q.id] === val ? '2px solid var(--c-emerald-500)' : '1px solid var(--c-slate-200)',
                                bgcolor: answers[q.id] === val ? 'var(--c-emerald-50)' : 'transparent',
                                transition: 'all 0.15s ease',
                                '&:hover': { bgcolor: 'var(--c-slate-50)', borderColor: 'var(--c-slate-400)' },
                              }}
                            />
                          ))}
                        </RadioGroup>
                        ...
                        >
                          {q.options.map((opt: string, i: number) => (
                            <FormControlLabel
                              ...
                              sx={{
                                mb: 1, p: 1.5, borderRadius: 2, mr: 0,
                                border: answers[q.id] === i ? '2px solid var(--c-emerald-500)' : '1px solid var(--c-slate-200)',
                                bgcolor: answers[q.id] === i ? 'var(--c-emerald-50)' : 'transparent',
                                transition: 'all 0.15s ease',
                                '&:hover': { bgcolor: 'var(--c-slate-50)', borderColor: 'var(--c-slate-400)' },
                              }}
                            />
              ...
              <Box sx={{ mt: 3, display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: 2 }}>
                ...
                <Button
                  ...
                  sx={{ background: 'linear-gradient(135deg, var(--c-blue-900), var(--c-emerald-500))', fontWeight: 'bold', px: 4 }}
                >
                  ...
                  <Paper sx={{ p: 3, mb: 3, borderRadius: 4, boxShadow: '0 4px 16px rgba(0,0,0,0.06)' }}>
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                      {currentModule.questions.map((q: any, i: number) => {
                        ...
                        return (
                          <Box key={q.id} sx={{ p: 2, borderRadius: 2.5, border: `1.5px solid ${isCorrect ? 'var(--c-green-300)' : 'var(--c-red-300)'}`, bgcolor: isCorrect ? 'var(--c-green-50)' : '#fff5f5' }}>
                            <Box sx={{ display: 'flex', gap: 1, alignItems: 'flex-start', mb: 1 }}>
                              {isCorrect ? <CheckCircle sx={{ color: 'var(--c-green-600)', mt: 0.25, flexShrink: 0 }} /> : <Cancel sx={{ color: 'var(--c-red-600)', mt: 0.25, flexShrink: 0 }} />}
                ...
                <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap', justifyContent: 'center' }}>
                  ...
                  {!isLastModule && (
                    <Button
                      ...
                      sx={{ background: 'linear-gradient(135deg, var(--c-blue-900), var(--c-emerald-500))', fontWeight: 'bold' }}
                    >
                      Next Module
                    </Button>
                  )}
