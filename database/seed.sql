...
-- Initial Seed Data (Idempotent / Safe for repeated runs)
-- =============================================================================
...
-- 6. SEED EXAMS (ASSIGNED TO CLASSROOMS)
          ...
          "items": [
            {
              ...
              "answer": "CSS Grid is 2-dimensional (handling rows and columns simultaneously), ideal for overall page layouts; Flexbox is 1-dimensional (row OR column), ideal for component distribution.",
